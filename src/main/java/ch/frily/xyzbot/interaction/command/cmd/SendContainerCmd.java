...
import ch.frily.xyzbot.container.StaticContainerRegistry;
...
public class SendContainerCmd implements ISlashCommand {
    ...
    public void execute(@NotNull SlashCommandInteractionEvent event) {
        ...
        StaticContainerRegistry containerEnum = StaticContainerRegistry.valueOf(embedValue);
        log.debug(containerEnum.name());
        List<Container> container = containerEnum.getContainers();
